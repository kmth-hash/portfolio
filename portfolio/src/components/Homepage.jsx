      ...
      <div className="homepage-body container-md ">
        <div className="row justify-content-between">
          <div className="col-md-7  container">
            ...
            <p>
              I'm a Full Stack Developer and Data Engineer who loves building
              stuff. I spend most of my time building projects, fixing bugs and
              trying not to crash that server.
            </p>
            <br />
